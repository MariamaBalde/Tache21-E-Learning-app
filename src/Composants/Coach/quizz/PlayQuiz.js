...
const PlayQuiz = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-center text-blue-600 mb-6">{quizData.title}</h2>

      {submitted ? (
        <div>
          <h3 className="text-lg font-semibold text-center">Votre score : {score} sur {quizData.questions.length}</h3>
          ...
          <div className="flex justify-around mt-6">
            ...
            <button
              onClick={() => navigate('/quizzes')} // Rediriger vers la liste des quiz
