...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 left-0 h-full w-42 p-4 text-white text-lg font-bold bg-[#191970] transform transition-transform duration-300 ease-in-out z-20 ${isOpen ? 'translate-x-0' : '-translate-x-full'
...
//             {/* Sidebar */}
//             <div
//                 className={`fixed top-0 left-0 h-full w-42 p-4 text-white text-lg font-bold  bg-blue-800 transform transition-transform duration-300 ease-in-out z-20 ${isOpen ? 'translate-x-0' : '-translate-x-full'
//                     } lg:translate-x-0 lg:static lg:h-screen lg:w-56`}
//             >
//                 <img src={logo} alt="Logo" className="h-12 w-12 mb-6 mx-auto" />
//                 <nav>
...
//                             <NavLink
//                                 to="/coach/dashboard"
//                                 className="flex items-center py-2 px-3 hover:bg-gray-400 rounded"
