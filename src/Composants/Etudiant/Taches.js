  ...
  return (
    <div className="p-6 bg-secondaryGreen min-h-screen relative">
      ...
      <div className="flex justify-between items-center mb-4">
        {/* Titre aligné à gauche avec style vert */}
        <h2 className="text-2xl font-semibold text-primaryGreen">Liste de vos tâches</h2>

        {/* Bouton de validation aligné avec le titre */}
      ...
      <div className="bg-white rounded-lg shadow-md p-6 flex gap-4">
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          {/* Liens utiles placé en bas à gauche */}
          <div className="mt-4">
            <p className="font-semibold">Liens utiles</p>
            <p className="text-textLight">{task.usefulLinks}</p>
          </div>
        </div>
