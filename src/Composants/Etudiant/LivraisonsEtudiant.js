...
//           <div
//             key={task.id}
//             className="bg-white rounded-lg shadow-lg p-4 border-t-4 border-green-500 flex flex-col justify-between"
//           >
//             {/* Header */}
//             <h3 className="text-lg font-bold text-center text-gray-800 mb-4">{task.titleText}</h3>
...
//                 className="w-1/2 py-2 mx-1 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600 transition duration-300"
//               >
//                 Commentaires
//               </button>
//               <button
//                 className="w-1/2 py-2 mx-1 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition duration-300"
//               >
//                 Livrables
//               </button>
//             </div>
